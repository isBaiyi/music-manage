    ...
    <div class="table">
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" size="mini" @click="centerDialogVisable=true">添加歌单</el-button>
            </div>
        </div>
        <!-- 查询所有歌单 -->
        ...
        <el-dialog title="添加歌单" :visible.sync="centerDialogVisable" width="400px" center>
            <el-form :model="registForm" ref="registForm" label-width="80px">
                <el-form-item prop="title" label="标题" size="mini">
                    <el-input v-model="registForm.title" placeholder="标题"></el-input>
                </el-form-item>
                <el-form-item prop="introduction" label="简介" size="mini">
                    <el-input v-model="registForm.introduction" placeholder="简介" type="textarea"></el-input>
                </el-form-item>
                <el-form-item prop="style" label="风格" size="mini">
                    <el-input v-model="registForm.style" placeholder="风格"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer">
