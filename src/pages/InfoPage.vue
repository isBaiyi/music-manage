        ...
        <el-row :gutter="20" class="mgb20">
            <el-col :span='12'>
                ...
                <div style="background-color:white">
                    <ve-pie :data="cousumerSex" :theme="options"/>
                </div>
            </el-col>
            <el-col :span='12'>
    ...
    methods: {
        ...
        getConsumer(){
            getAllConsumer().then(res => {
                ...
                this.cousumerSex.rows[0]['总数'] = this.setSex(1, res); // 获取男
                this.cousumerSex.rows[1]['总数'] = this.setSex(0, res); // 获取女
            })
        },
        // 根据性别获取用户数
        setSex(sex, val){
        ...
        getSinger(){
            getAllSinger().then(res => {
                ...
                this.singerSex.rows[0]['总数'] = this.setSex(0, res); // 获取女
                this.singerSex.rows[1]['总数'] = this.setSex(1, res); // 获取男
                this.singerSex.rows[2]['总数'] = this.setSex(2, res); // 获取组合
                this.singerSex.rows[3]['总数'] = this.setSex(3, res); // 获取不明
                for (let item of res) {
